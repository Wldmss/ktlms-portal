<%--
  Migrated from genius: WebContent/WEB-INF/jsp/mobile/login/login.jsp
        ...
        <section class="mobile-login">
            ...
            <article class="login-form-wrap">
                ...
                <div class="certification-number">
                    <button type="button" class="btn-m-resend" onClick="sendSmsAuth();">인증번호 재전송</button>
                    <div class="inp-text">
...
<script type="text/javascript">
    ...
    function getLoginKey() {
        ...
        $.ajax({
            url: loginMobileEndpoint('getEncKeyAjax'),
            async: false,
            type: 'POST',
            timeout: 3000,
            dataType: "json",
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.resultCode == "1") {
                    $('.certification-number').css('display', 'block');
                    $(".certification-time").css('display', 'block');
                    ...
                    timeInterval = setInterval(function () {
                        if (timeCheck > 0) {
                            ...
                            clearInterval(timeInterval);
                            $(".certification-time").css('display', 'none');
                            timeCheck = initTime;
